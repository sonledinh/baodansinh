 ...
 */
(function(n){typeof define=="function"&&define.amd?define(["jquery"],n):n(jQuery)})(function(n){function u(){if(!n.contains(document.documentElement,this))return n(this).timeago("dispose"),this;var r=e(this),u=t.settings;return isNaN(r.datetime)||(u.cutoff==0||Math.abs(f(r.datetime))<u.cutoff)&&n(this).text(i(r.datetime)),this}function e(i){if(i=n(i),!i.data("timeago")){i.data("timeago",{datetime:t.datetime(i)});var r=n.trim(i.text());t.settings.localeTitle?i.attr("title",i.data("timeago").datetime.toLocaleString()):r.length>0&&!(t.isTime(i)&&i.attr("title"))&&i.attr("title",r)}return i.data("timeago")}function i(n){return t.inWords(f(n))}function f(n){return(new Date).getTime()-n.getTime()}var t,r;n.timeago=function(t){return t instanceof Date?i(t):typeof t=="string"?i(n.timeago.parse(t)):typeof t=="number"?i(new Date(t)):i(n.timeago.datetime(t))};t=n.timeago;n.extend(n.timeago,{settings:{refreshMillis:6e4,allowPast:!0,allowFuture:!1,localeTitle:!1,cutoff:0,strings:{prefixAgo:null,prefixFromNow:null,suffixAgo:"trÆ°á»›c",suffixFromNow:"from now",inPast:"any moment now",seconds:"chÆ°a Ä‘áº¿n 1 phĂºt",minute:"1 phĂºt",minutes:"%d phĂºt",hour:"1 giá»",hours:"%d giá»",day:"1 ngĂ y",days:"%d ngĂ y",month:"1 thĂ¡ng",months:"%d thĂ¡ng",year:"1 nÄƒm",years:"%d nÄƒm",wordSeparator:" ",numbers:[]}},inWords:function(t){function r(r,u){var f=n.isFunction(r)?r(u,t):r,e=i.numbers&&i.numbers[u]||u;return f.replace(/%d/i,e)}var a,s;if(!this.settings.allowPast&&!this.settings.allowFuture)throw"timeago allowPast and allowFuture settings can not both be set to false.";var i=this.settings.strings,h=i.prefixAgo,c=i.suffixAgo;if(this.settings.allowFuture&&t<0&&(h=i.prefixFromNow,c=i.suffixFromNow),!this.settings.allowPast&&t>=0)return this.settings.strings.inPast;var f=Math.abs(t)/1e3,e=f/60,o=e/60,u=o/24,l=u/365;return a=f<45&&r(i.seconds,Math.round(f))||f<90&&r(i.minute,1)||e<45&&r(i.minutes,Math.round(e))||e<90&&r(i.hour,1)||o<24&&r(i.hours,Math.round(o))||o<42&&r(i.day,1)||u<30&&r(i.days,Math.round(u))||u<45&&r(i.month,1)||u<365&&r(i.months,Math.round(u/30))||l<1.5&&r(i.year,1)||r(i.years,Math.round(l)),s=i.wordSeparator||"",i.wordSeparator===undefined&&(s=" "),n.trim([h,a,c].join(s))},parse:function(t){var i=n.trim(t);return i=i.replace(/\.\d+/,""),i=i.replace(/-/,"/").replace(/-/,"/"),i=i.replace(/T/," ").replace(/Z/," UTC"),i=i.replace(/([\+\-]\d\d)\:?(\d\d)/," $1$2"),i=i.replace(/([\+\-]\d\d)$/," $100"),new Date(i)},datetime:function(i){var r=t.isTime(i)?n(i).attr("datetime"):n(i).attr("title");return t.parse(r)},isTime:function(t){return n(t).get(0).tagName.toLowerCase()==="time"}});r={init:function(){var r=n.proxy(u,this),i;r();i=t.settings;i.refreshMillis>0&&(this._timeagoInterval=setInterval(r,i.refreshMillis))},update:function(i){var r=t.parse(i);n(this).data("timeago",{datetime:r});t.settings.localeTitle&&n(this).attr("title",r.toLocaleString());u.apply(this)},updateFromDOM:function(){n(this).data("timeago",{datetime:t.parse(t.isTime(this)?n(this).attr("datetime"):n(this).attr("title"))});u.apply(this)},dispose:function(){this._timeagoInterval&&(window.clearInterval(this._timeagoInterval),this._timeagoInterval=null)}};n.fn.timeago=function(n,t){var i=n?r[n]:r.init;if(!i)throw new Error("Unknown function name '"+n+"' for timeago");return this.each(function(){i.call(this,t)}),this};document.createElement("abbr");document.createElement("time")});fbClient={version:"v3.3",appId:"2408466829383018",xfbml:!0,status:!0,likeCB:null,loaded:null,init:function(){var n=this;$(document).ready(function(){$("#fb-root").length===0&&$("body").prepend('<div id="fb-root"><\/div>');n.fbLoad("//connect.facebook.net/vi_VN/sdk.js",function(){FB.init({appId:n.appId,status:n.status,xfbml:n.xfbml,version:n.version});FB.Event.subscribe("xfbml.render",n.renderButton)})})},fbParse:function(n){try{FB.XFBML.parse(n)}catch(t){}},fbLoad:function(n,t){t=typeof t!="undefined"?t:{};$.ajax({type:"GET",url:n,success:t,dataType:"script",cache:!0})},getLikeShareCount:function(n,t,i,r){$.ajax({type:"GET",url:appSettings.sharefbApiDomain+"/?urls="+n,dataType:"JSON",success:function(n){var c=n[0],u=parseFloat(c.share_count),f=parseFloat(c.like_count),e=f+u,o=e+"",s=f+"",h=u+"";e>1e4?o=Math.floor(e/1e3)+"k+":e>1e3&&(o=Math.floor(e/1e3)+"k"+e%1e3);u>1e4?h=Math.floor(u/1e3)+"k+":u>1e3&&(h=Math.floor(u/1e3)+"k"+u%1e3);f>1e4?s=Math.floor(f/1e3)+"k+":f>1e3&&(s=Math.floor(f/1e3)+"k"+f%1e3);$(t)!=null&&$(t).html(h);$(i)!=null&&$(i).html(s);$(r)!=null&&$(r).html(o)}})},shareClick:function(n){var t=screen.width/2-350,i=screen.height/2-225,r=n!=null?n:document.location.href,u=window.open("http://www.facebook.com/sharer.php?u="+r,"chia sáº»","toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=700, height=485, top="+i+", left="+t);return u.focus(),!1},sendClick:function(n){try{FB.ui({method:"send",link:n})}catch(t){}return!1},fanpage:function(){setTimeout(function(){$(".social-share .fb-like iframe").is(":visible")||$(".social-share").remove()},1e4)},renderButton:function(){$(".fb-send").length>0&&$(".fb-send").removeClass("hidden").show().parent(".fbSendWrap").children(':not(".fb-send")').remove();$(".fb-like").length>0&&$(".fb-like").removeClass("hidden").show().parent(".fbLikeWrap").children(':not(".fb-like")').remove()}};$(document).ready(function(){try{sharedScript.init();$(".lazy").lazy()}catch(n){}});sharedScript={init:function(){var t=this,i,n;$(".need-get-timeago").timeago();$("#search_button").click(function(){$("#search_field").val().length<=0?$("#search_field").focus():t.OnSearchClick("#search_field")});$("#search_field").keypress(function(n){var i=n.keyCode?n.keyCode:n.which;i=="13"&&t.OnSearchClick("#search_field")});$(".loading-indicator > *").each(function(){$(this).css("animation-duration",Math.round(Math.random()*6)+"s")});$("#btn_back_2_top").on("click",function(){$("html").animate({scrollTop:0},800)});t.loadMenu();t.bindMenuAccount();i=0;t.trimLine();checkLazyImages(0);document.addEventListener("scroll",processScroll,!1);n=function(){for(var n,i=$(".breadcumb, .boxcategory .headbox"),t=0;t<i.length;t++)n=$(i[t]),n.find(".swiper-container").css("max-width",n.width()-n.find(".wrappertag").width()-20+"px")};n();setTimeout(n,100);setTimeout(n,350);$(window).on("scroll",n).on("resize",n)},loadSwipper:function(n,t,i,r=false){Swiper(n,{nextButton:t,prevButton:i,pagination:n+" .swiper-pagination",slidesPerGroup:1,slidesPerView:"auto",simulateTouch:!0,paginationClickable:!0,spaceBetween:0,loop:!1,preventClicks:!1,preventClicksPropagation:!1,autoHeight:r})},loadSlimScroll:function(n,t,i){$(n).slimscroll({height:t,color:i})},loadLatestNews:function(){$("#float-new").length!=0&&$("#float-new .news-stream").hasClass("loading")&&$.ajax({url:"/ajax/loadlastestnews.htm",dataType:"html",success:function(n){n&&setTimeout(function(){$("#float-new .news-stream").removeClass("loading").html(n);sharedScript.trimLine()},500)},failed:function(){$("#header [data-header-action='float-new']").click().remove();alert("CĂ³ lá»—i xáº£y ra trong quĂ¡ trĂ¬nh xá»­ lĂ½, vui lĂ²ng táº£i láº¡i trang nĂ y!")}})},loadMostRead:function(){$("#float-trending").length!=0&&$("#float-trending .news-stream").hasClass("loading")&&$.ajax({url:"/ajax/loadmostread.htm",dataType:"html",success:function(n){if(!n){$("#float-trending .news-stream").removeClass("loading").html("<li style='color:#064ea9;font:normal 18px RobotoBold;text-align:center'>KhĂ´ng cĂ³ dá»¯ liá»‡u!<\/li>");return}setTimeout(function(){$("#float-trending .news-stream").removeClass("loading").html(n);sharedScript.trimLine()},500)},failed:function(){$("#header [data-header-action='float-trending']").click().remove();alert("CĂ³ lá»—i xáº£y ra trong quĂ¡ trĂ¬nh xá»­ lĂ½, vui lĂ²ng táº£i láº¡i trang nĂ y!")}})},loadMenu:function(){var n=this;$("#float-box, #float-box .float-box").hide();$("#header [data-header-action]").on("click",function(){var t=$(this),i=$("#float-box"),r;if($("#header [data-header-action]").find(".icon.icon-menu").removeClass("close"),$("body").removeClass("no-scroll"),t.hasClass("active"))i.hide().find(".float-box").hide(),$("#header [data-header-action]").removeClass("active").find(".icon.icon-menu").removeClass("close");else{r=t.attr("data-header-action");$("#header [data-header-action]").removeClass("active");t.addClass("active").find(".icon.icon-menu").addClass("close");i.find(".float-box").hide();i.show().find(".float-box#"+r).show().animate({scrollTop:0},"smooth");$("body").addClass("no-scroll");switch(r){case"float-trending":n.loadMostRead();break;case"float-new":n.loadLatestNews()}}});$("#float-box .float-box-cover").on("click",function(){var n=$("#float-box");n.hide().find(".float-box").hide();$("#header [data-header-action]").removeClass("active").find(".icon.icon-menu").removeClass("close");$("body").removeClass("no-scroll")})},OnSearchClick:function(n){var i,t;if(n)if(i=$(n),i.val()!=""){if(t=i.val(),t=t.replace(/[<][\/]?[a-z0-9-]+\s*(\s*[a-z0-9-]+([=]?["']?[^>]*["']?)?)*\s*[>]/ig," ").replace(/[<][!].*[>]/ig," ").trim().replace(/[?&*\`\/\\]/ig,"").replace(/["]/ig,"").replace(/^\s+|\s+$/g,"").replace(/<\/?[a-z0-9-]+[^>]*>/ig,"").replace(/[a-z0-9_]+[(]/ig,""),t=="")return alert("Tá»« khĂ³a khĂ´ng Ä‘Æ°á»£c Ä‘á»ƒ trá»‘ng hoáº·c chá»©a kĂ½ tá»± Ä‘áº·c biá»‡t!"),!1;$(n).attr("disabled","disabled").css("background","#c0c0c0");t=encodeURIComponent(t);url="/tim-kiem.htm?search="+t;window.location.href=url}else return alert("Báº¡n chÆ°a nháº­p tá»« khĂ³a tĂ¬m kiáº¿m!"),!1},trimLine:function(){$("[data-trimline]").each(function(){var n=$(this);n.attr("data-trimline")&&/^[0-9]+$/ig.test(n.attr("data-trimline"))&&n.trimLine(n.attr("data-trimline"))})},bindMenuAccount:function(){var n;$("#comment-frame").length||$(".page-menu").append('<iframe id="comment-frame" src="'+appSettings.ajaxDomain+'/user-icon.htm"><\/iframe>');$(".page-menu .menu-account").hide().find("input").val("");$(".menu-account-form, #form-menu-login, #form-menu-register").slideUp();n=function(n){var t;if(n.origin!=appSettings.ajaxDomain,n.data&&n.data.act){$(".page-menu .menu-account").hide();$("#form-menu-login, #form-menu-register").slideUp();switch(n.data.act){case"popup":t=n.data;t.isLogged&&(t.name||t.email)?($("#btn-menu-account").html((t.name||t.email)+""),$(".menu-account").removeClass("active").hide().find(".menu-account-form").hide(),$(".menu-account").hide(),$(".menu-account.logged").show(),$(".menu-account-form").hide()):($("#menu_cmt_alert").show().html(t.alert||t.Message||""),$(".menu-account").show(),$(".menu-account.logged").hide());break;case"cnnd_home_signal":t=n.data;t.isLogged?($("#btn-menu-account").html((t.name||t.email||"ÄĂ£ Ä‘Äƒng nháº­p")+""),$(".menu-account").removeClass("active").hide().find(".menu-account-form").hide(),$(".menu-account.logged").show(),$(".page-menu .menu-account.logged .menu-account-form strong").text(t.email||"(khĂ´ng xĂ¡c Ä‘á»‹nh)")):($(".menu-account").show(),$(".menu-account.logged").hide());$(".menu-account .menu-account-btn").removeClass("active");break;case"resize":$('[data-comment-id="'+n.data.id+'"]').css("height",n.data.height+10+"px")}}};window.addEventListener("message",n,!1);var t=function(){$("#menu_img_captcha").attr("src",appSettings.ajaxDomain+"/captcha.htm?"+(new Date).getTime())},i={init:function(){if(window.location.href.indexOf("https")!=0){$("#cmt-account-social").remove();return}var n=this;gapi.load("auth2",function(){gapi.auth2.init({clinet_id:"656143167307-gmbndsskl90kfmt7eufu6q6208s3p72o.apps.googleusercontent.com",scope:"email profile",fetch_basic_profile:!0})});typeof fbClient=="object"&&fbClient.init();$("#cmt-account-social button[data-type], .menu-account-form .account-social button[data-type]").on("click",function(){n["login"+$(this).attr("data-type")](function(n){n.Success?($("#comment-frame-header").length&&($("#comment-frame-header")[0].src+=($("#comment-frame-header")[0].src.indexOf("?")>=0?"&":"?")+"social-login=1"),$("#comment-frame").length&&($("#comment-frame")[0].src+=($("#comment-frame")[0].src.indexOf("?")>=0?"&":"?")+"social-login=1"),$("#cmt-account .tabs .close").click()):$("#menu_cmt_alert").html(n.Message||"CĂ³ lá»—i xáº£y ra, vui lĂ²ng thá»­ láº¡i sau Ă­t phĂºt!")})});try{FB.AppEvents.logPageView()}catch(t){}},loginFacebook:function(n){function t(n){FB.api("/me",{fields:"id, name, email"},function(t){console.debug(t);typeof n=="function"&&n(t)})}var i=this;FB.login(function(i){i.authResponse?t(function(t){t.social="facebook";t.accessToken=i.authResponse.accessToken;$.ajax({url:appSettings.ajaxDomain+"/api/social.api",xhrFields:{withCredentials:!0},data:t,type:"post",dataType:"json",beforeSend:function(n){typeof _OTK!="undefined"&&n.setRequestHeader("OTK",_OTK)},success:function(t){n(t)}})}):$("#menu_cmt_alert").html("Báº¡n Ä‘Ă£ tá»« chá»‘i cáº¥p quyá»n cho BĂ¡o DĂ¢n Sinh truy cáº­p tĂ i khoáº£n Facebook")},{scope:"public_profile,email"})},loginGoogle:function(n){function i(n,t){n.social="google";$.ajax({url:appSettings.ajaxDomain+"/api/social.api",xhrFields:{withCredentials:!0},data:n,type:"post",dataType:"json",beforeSend:function(n){typeof _OTK!="undefined"&&n.setRequestHeader("OTK",_OTK)},success:function(n){typeof t=="function"&&t(n)}})}var f=this;if(gapi.auth2.getAuthInstance().isSignedIn.get()){var t=gapi.auth2.getAuthInstance().currentUser.get().getBasicProfile(),r=gapi.auth2.getAuthInstance().currentUser.get().getAuthResponse().access_token,u={id:t.getId(),name:t.getName(),email:t.getEmail(),accessToken:r};i(u,n)}else gapi.auth2.getAuthInstance().signIn().then(function(){var t=gapi.auth2.getAuthInstance().currentUser.get().getBasicProfile(),r=gapi.auth2.getAuthInstance().currentUser.get().getAuthResponse().access_token,u={id:t.getId(),name:t.getName(),email:t.getEmail(),accessToken:r};i(u,n)},function(){$("#menu_cmt_alert").html("Báº¡n Ä‘Ă£ tá»« chá»‘i cáº¥p quyá»n cho BĂ¡o DĂ¢n Sinh truy cáº­p tĂ i khoáº£n Google")})}},r=function(){$("#btn-menu-login").on("click",function(){$(".page-menu .menu-account input[type=password]").val("");var n=$(this);n.find("input").val("");n.hasClass("active")?(n.removeClass("active"),$(".menu-account-form, .menu-account-form > *").not(".account-social").slideUp()):($("#btn-menu-register").removeClass("active"),n.addClass("active"),$("#form-menu-register").slideUp(),$("#form-menu-login").slideDown(),$("#menu_cmt_alert").show().html(""),setTimeout(function(){$(".menu-account-form").slideDown()},150))});$("#btn-menu-register").on("click",function(){$(".page-menu .menu-account input[type=password]").val("");var n=$(this);n.find("input").val("");n.hasClass("active")?(n.removeClass("active"),$(".menu-account-form, .menu-account-form > *").not(".account-social").slideUp()):(t(),$("#btn-menu-login").removeClass("active"),n.addClass("active"),$("#form-menu-login").slideUp(),$("#form-menu-register").slideDown(),$("#menu_cmt_alert").show().html(""),setTimeout(function(){$(".menu-account-form").slideDown()},150))});$("#btn-menu-account").on("click",function(){$(".page-menu .menu-account.logged .menu-account-form").toggle()});$("#menu_btn_login").on("click",function(){console.debug("[VCC] Login");$("#menu_cmt_alert").html("");var n,t;if(n=$("#menu_login_email").val(),t=$("#menu_login_password").val(),!/^[a-z0-9-_\.]+[@][0-9a-z-]+(\.[0-9a-z-]+)+$/ig.test(n)||t.length<8){$("#menu_cmt_alert").html("Email hoáº·c máº­t kháº©u khĂ´ng Ä‘Ăºng!");return}$(".page-menu .menu-account input[type=password]").val("");$(".page-menu .menu-account").hide();$("#comment-frame")[0].contentWindow.postMessage({act:"cmlogin",info:{email:n,password:t}},"*")});$("#menu_btn_sign").on("click",function(){console.debug("[VCC] Signup");$("#menu_cmt_alert").html("");var t,i,n,u,r;if(t=$("#menu_sign_email").val(),i=$("#menu_sign_name").val(),n=$("#menu_sign_password").val(),u=$("#menu_sign_repassword").val(),r=$("#menu_sign_captcha").val(),!/^[a-z0-9-_\.]+[@][0-9a-z-]+(\.[0-9a-z-]+)+$/ig.test(t)){$("#menu_cmt_alert").html("Email khĂ´ng há»£p lá»‡");return}if(n.length<8||n!=u){$("#menu_cmt_alert").html("Máº­t kháº©u pháº£i cĂ³ Ă­t nháº¥t 8 kĂ½ tá»±, chá»©a Ă­t nháº¥t 1 chá»¯ sá»‘ vĂ  1 chá»¯ cĂ¡i");return}if(!(/[a-z]/ig.test(n)&&/[0-9]/ig.test(n))){$("#menu_cmt_alert").html("Máº­t kháº©u pháº£i chá»©a Ă­t nháº¥t 1 chá»¯ sá»‘ vĂ  1 chá»¯ cĂ¡i");return}if(i.length<=0){$("#menu_cmt_alert").html("Vui lĂ²ng nháº­p há» tĂªn cá»§a báº¡n!");return}if(r.length<=0){$("#menu_cmt_alert").html("Vui lĂ²ng Ä‘iá»n mĂ£ xĂ¡c nháº­n trong áº£nh!");return}$(".page-menu .menu-account input[type=password]").val("");$(".page-menu .menu-account").hide();$("#comment-frame")[0].contentWindow.postMessage({act:"cmsignup",info:{email:t,password:n,name:i,captcha:r}},"*")});$("#menu_reload_captcha").on("click",t);$("#btn-menu-logout").on("click",function(){$(".page-menu .menu-account input").val("");$(".page-menu .menu-account").hide();$("#comment-frame")[0].contentWindow.postMessage({act:"cmlogout",info:{}},"*")});i.init();console.debug("[VCC] Menu_Comment box is ready.")};setTimeout(r,100)}};var home={init:function(){}},LoadTimeline={extension:".htm",url:"",pageIndex:2,nameClassOrId:"",delaySuccess:200,btnmore:"",Init:function(){var n=this;$(n.btnmore).on("click",function(){n.getData(n.pageIndex)})},getData:function(){var n=this;$.ajax({url:n.url+"trang-"+n.pageIndex+n.extension,dataType:"html",success:function(t){setTimeout(function(){n.successCallback(t)},n.delaySuccess)}})},successCallback:function(n){var t=this,i=n.replace(/^(?=\n)$|^\s*|\s*$|\n\n+/gm,"");i!==""&&i.length>50?($(t.nameClassOrId).append(n),t.pageIndex++):$(t.btnmore).remove();$(".need-get-timeago").timeago()},removeDup:function(){var t=this,n={},i=$(t.nameClassOrId+" li.qitem");i.each(function(){var t=$(this).attr("data-newsid");n[t]?$(this).remove():n[t]=!0})}},detailscript={getWidthHeight:function(n,t,i){var r=new Image;r.src=n;r.onload=function(){i(this.width,this.height,n,t)}},initPersonalizeStream:function(){var r,e,f;if($("#ajax-personalize").length){var i=0,n=!1,u="20170314102127128",t=getCookie("_uif");t&&(t=decodeURIComponent(t.replace("=","")),r=t.split("|").filter(function(n){return/^__uid\:[0-9]+$/ig.test(n)}),r.length&&(u=r[0].split(":")[1]));e=String.format("https://nspapi.aiservice.vn/request/client?guid={3}&domain={0}&boxid={1}&url={2}&page=","ttvh",1,window.location.href,u);f=function(){if(!n){i++;$("#footer *").hide();$("#ajax-personalize .loading-indicator").show();$("#ajax-personalize .btn-xemthem").hide();n=!0;var t=window.location.href.split("-").reverse()[0].split(".")[0];$.get("/ajax/lastest-stream/0-"+i+".htm",function(i){var r,u;if(!i){$("#footer *").show();$("#ajax-personalize .loading-indicator").hide();$("#ajax-personalize .btn-xemthem").hide();return}r=[];r.push((t||"0")+"");$("[data-newsid]").each(function(n){r.push($(n).attr("data-newsid")||"0")});u=$(i.replace(/<h4/ig,"<div").replace(/<\/h4>/ig,"<\/div>"));u.each(function(n){r.indexOf($(n).attr("data-newsid"))>=0&&$(n).remove()});setTimeout(function(){u.insertBefore($("#ajax-personalize .btn-xemthem").closest("li"));$("[data-newsid="+t+"]").remove();$("#footer *").show();$("#ajax-personalize .loading-indicator").hide();$("#ajax-personalize .btn-xemthem").show();n=!1},2e3)})}};$("#ajax-personalize .btn-xemthem").on("click",function(){f()}).click();$(window).on("scroll",function(){setTimeout(function(){var t=$("#ajax-personalize .btn-xemthem");!n&&t.length&&t.offset().top-t.height()-$(window).height()<(typeof scrollY=="function"?this.window.scrollY():window.scrollY)&&i%3!=0&&$("#ajax-personalize .btn-xemthem").click()},Math.round(Math.random()*150))})}},initAjaxLoader:function(){var n=function(n){$.get($(n).attr("data-ajax"),function(t){if(!t){$(n).remove();return}($(n).html(t).removeAttr("data-ajax"),typeof _news_id!="undefined"&&_news_id)&&($("[data-newsid]").each(function(){$(this).attr("data-newsid")==_news_id&&$(this).remove()}),$(n).attr("data-ajax-limit")&&/^[0-9]+$/ig.test($(n).attr("data-ajax-limit"))&&$(n).find("li:nth-child(n+"+(Number($(n).attr("data-ajax-limit"))+1)+")").hide())})};$("[data-ajax]").each(function(){var t=$(this);if(!t.attr("data-ajax")){t.remove();return}n(t)});this.initPersonalizeStream()},InitLightBox:function(n){var r=this,t,i;if(!$(n).find(".pswp").length){$(n).append('<div class="pswp" tabindex="-1" role="dialog" aria-hidden="true"> <div class="pswp__bg"><\/div> <div class="pswp__scroll-wrap"> <div class="pswp__container"> <div class="pswp__item"><\/div> <div class="pswp__item"><\/div> <div class="pswp__item"><\/div> <\/div> <div class="pswp__ui pswp__ui--hidden"> <div class="pswp__top-bar"> <div class="pswp__counter"><\/div> <button class="pswp__button pswp__button--close" title="Close (Esc)"><\/button> <button class="pswp__button pswp__button--fs" title="Toggle fullscreen"><\/button> <button class="pswp__button pswp__button--zoom" title="Zoom in/out"><\/button> <div class="pswp__preloader"> <div class="pswp__preloader__icn"> <div class="pswp__preloader__cut"> <div class="pswp__preloader__donut"> <\/div> <\/div> <\/div> <\/div> <\/div> <div class="pswp__share-modal pswp__share-modal--hidden pswp__single-tap"> <div class="pswp__share-tooltip"> <\/div> <\/div> <button class="pswp__button pswp__button--arrow--left" title="Previous (arrow left)"><\/button> <button class="pswp__button pswp__button--arrow--right" title="Next (arrow right)"><\/button> <div class="pswp__caption"> <div class="pswp__caption__center"><\/div> <\/div> <\/div> <\/div> <\/div>');t=[];i=0;$(n).find(".VCSortableInPreviewMode[type='tempwidgets'],.VCSortableInPreviewMode[type='LayoutAlbum'],.VCSortableInPreviewMode[type='Photo']").each(function(){var n=$(this).find(".PhotoCMS_Caption").text();n||(n=$(this).find(".LayoutAlbumCaption").text());$(this).find("img").each(function(){$(this).closest("a").addClass("detail-img-lightbox")});$(this).find(".detail-img-lightbox,.sp-img-zoom").each(function(){var u="";u=typeof $(this).find("img").attr("src")!="undefined"?$(this).find("img").attr("src"):$(this).data("original");r.getWidthHeight(u,this,function(r,u,f,e){var o={src:f,w:r,h:u,title:n};$(e).attr("data-index",i);t.push(o);i++})})});$(".detail-img-lightbox,.sp-img-zoom").on("click",function(n){n.preventDefault();$(".nav-up").addClass("nav-down").removeClass("nav-up");var i=$(".pswp")[0],r={index:$(this).data("index"),bgOpacity:.85,showHideOpacity:!0},u=new PhotoSwipe(i,PhotoSwipeUI_Default,t,r);u.init()})}},loadcothebanquantam:function(n){$(".cothebanquantam .btnxemthem").click(function(){$.ajax({url:"/ajax/cothebanquantam/"+n+".htm",dataType:"html",success:function(n){setTimeout(function(){var t=n.replace(/^(?=\n)$|^\s*|\s*$|\n\n+/gm,"");t!==""&&t.length>50&&$(".cothebanquantam ul").append(n);$(".cothebanquantam .btnxemthem").remove()},200)},error:function(){$(".cothebanquantam .btnxemthem").remove()}})})},loadchantrang:function(n){$("#chantrangchitiet").length!=0&&$.ajax({url:"/ajax/loadchantrangchitiet/"+n+".htm",dataType:"html",success:function(n){setTimeout(function(){var t=n.replace(/^(?=\n)$|^\s*|\s*$|\n\n+/gm,"");t!==""&&t.length>50&&($("#chantrangchitiet").append(n),$(".need-get-timeago").timeago())},200)}})},admicroInPage:function(){if(appSettings.allowAds=="1"){var n=$(".entry-body [data-role=content]").children().filter(function(){return!!$(this).text().trim()}),t=n.length;n.each(function(n){n==0&&($('<div style="clear:both;"><\/div><zone id="juxhjpnk"><\/zone><div style="clear:both;padding-bottom:10px"><\/div>').insertAfter($(this)),arfAsync.push("juxhjpnk"));n==Math.round(t/2)&&($('<div style="clear:both;"><\/div><zone id="juxhm6tn"><\/zone><div style="clear:both;padding-bottom:10px"><\/div>').insertAfter($(this)),arfAsync.push("juxhm6tn"));n==t-2&&($('<div style="clear:both;"><\/div><zone id="juxhn1mp"><\/zone><div style="clear:both;padding-bottom:10px"><\/div>').insertAfter($(this)),arfAsync.push("juxhn1mp"))});n=$(".entry-body [data-role=content]").children().filter(function(){return!!$(this).text().trim()})}}},tagsearchscript={init:function(n,t,i,r,u){var f=Math.ceil(i/15),e="/ajax/"+n+"-stream/"+t+"-{0}.htm",o=function(){if(r>=f){$("[data-readmore-btn]").remove();return}$("[data-readmore-btn]").is(":hidden")||(window._cnnd_loadCount++,r++,$("#footer *").hide(),$("[data-readmore-btn]").closest(".news-stream").find(".loading-indicator").show(),$("[data-readmore-btn]").hide(),$.get(String.format(e,r),function(n){var t=$("[data-readmore-btn]"),i;if(!n){t.closest(".news-stream").find(".loading-indicator").remove();t.remove();$("#footer *").show();return}i=n;setTimeout(function(){$(i).insertBefore(t);$("[data-readmore-btn]").show();sharedScript.trimLine();$("[data-readmore-btn]").show();$("#footer *").show();$("[data-readmore-btn]").closest(".news-stream").find(".loading-indicator").hide();r>=f&&($("[data-readmore-btn]").closest(".news-stream").find(".loading-indicator").remove(),$("[data-readmore-btn]").remove())},1e3);typeof u=="function"&&u()}))};$("[data-readmore-btn] .btn-xemthem").on("click",function(){try{o()}catch(n){$("[data-readmore-btn]").closest(".news-stream").find(".loading-indicator").remove();$("[data-readmore-btn]").remove();$("#footer *").show()}});window._cnnd_loadCount=0;$(window).on("scroll",function(){var n,t;if(window._cnnd_loadCount&&window._cnnd_loadCount%3==0){$("#footer *").show();return}if(n=$("[data-readmore-btn] .btn-xemthem"),!n||!n.length){$("#footer *").show();return}t=typeof window.scrollY!="function"?window.scrollY:window.scrollY();t>=n.offset().top-$(window).height()+n.height()*3&&n.click()});i<=0&&($(".box-info").hide(),$('<div class="box-info wrapper m-30-b">KhĂ´ng tĂ¬m tháº¥y bĂ i viáº¿t phĂ¹ há»£p!<\/div>').insertAfter($(".category-header").first()))}};checkRunInit();window._cnnd||(window._cnnd={});window._cnnd.slideshow={elements:{},hovering:{},intervals:{},scrolling:{},pageX:{},running:function(n){if(!document.hasFocus())return!1;if(!n)return!0;var t=document.getElementById(n);return window.scrollY<t.offsetTop+Math.ceil(t.offsetHeight/2)},intervalDecoration:function(n){return function(){window._cnnd.slideshow.running(n)&&(!window._cnnd.slideshow.hovering[n]||$("#"+n).attr("data-slideshow-nonstop"))&&window._cnnd.slideshow.changeSlide(n+"",0,1)()}},changeSlide:function(n,t,i,r){return function(){var u,s,p,v,w,b,c,h,f,o,l,y,e,a;r&&$(r[0]).hasClass("disabled")&&!$(r[0]).attr("data-slideshow-ignorestate")||window._cnnd.slideshow.scrolling[n]||(u=0,t&&(u=t.attr("data-slideshow-item")),s=$("#"+n).attr("data-slideshow-step"),s&&/^[0-9]+$/.test(s)?u*=s:s=1,i&&(u=(Math.floor(+window._cnnd.slideshow.elements[n]/s)+i)*s),p=$("#"+n+" [data-slideshow-slides] [data-slideshow-item]"),v=p.length,!$("#"+n).attr("data-slideshow-loop")&&(u>=v||u<0))||(u>=v?u=0:u<0&&(u=v-1),$("#"+n+" [data-slideshow-next], [data-slideshow-prev]").removeClass("disabled"),u===0&&$("#"+n+" [data-slideshow-prev]").addClass("disabled"),u>=v-s&&$("#"+n+" [data-slideshow-next]").addClass("disabled"),window._cnnd.slideshow.elements[n]!=null)&&(window._cnnd.slideshow.elements[n]=u,$("#"+n+" [data-slideshow-thumbs] [data-slideshow-item], #"+n+" [data-slideshow-slides] [data-slideshow-item]").removeClass("active"),$(p[u]).addClass("active"),f=$($("#"+n+" [data-slideshow-thumbs] [data-slideshow-item]")[u/(s||1)]),f.addClass("active"),o=$("#"+n+" [data-slideshow-thumbs]"),c=0,f.css("padding-left")&&(c+=parseFloat(f.css("padding-left").replace(/[a-z]+/ig,""))),f.css("margin-left")&&(c+=parseFloat(f.css("margin-left").replace(/[a-z]+/ig,""))),c=parseFloat(c+""),o.attr("data-slideshow-scrollable")&&(l=o[0].offsetLeft+c<f.offset().left,window._cnnd.slideshow.scrolling[n]=!0,w=setInterval(function(){if(l&&o[0].offsetLeft+c>=f.offset().left||!l&&o[0].offsetLeft+c<=f.offset().left||l&&o[0].scrollLeft+o[0].offsetWidth>=o[0].scrollWidth||!l&&o[0].scrollLeft===0){clearInterval(w);window._cnnd.slideshow.scrolling[n]=!1;return}l?o[0].scrollLeft+=10:o[0].scrollLeft-=10},1)),h=0,f.css("padding-left")&&(h+=parseFloat(f.css("padding-left").replace(/[a-z]+/ig,""))),f.css("margin-left")&&(h+=parseFloat(f.css("margin-left").replace(/[a-z]+/ig,""))),h=parseFloat(h+""),y=$($("#"+n+" [data-slideshow-slides] [data-slideshow-item]")[u]),e=$("#"+n+" [data-slideshow-slides]"),e.attr("data-slideshow-scrollable")&&(a=+e[0].offsetLeft+h<y.offset().left,window._cnnd.slideshow.scrolling[n]=!0,b=setInterval(function(){if(a&&e.offset().left+h>=y.offset().left||!a&&e.offset().left+h<=y.offset().left||a&&e[0].scrollLeft+e[0].offsetWidth>=e[0].scrollWidth||!a&&e[0].scrollLeft===0){e[0].scrollLeft+=y.offset().left-(e.offset().left+h);clearInterval(b);window._cnnd.slideshow.scrolling[n]=!1;return}a?e[0].scrollLeft+=10:e[0].scrollLeft-=10},1)),window._cnnd.slideshow.trimlineSlide(n))}},tempInterval:null,trimlineSlide:function(n){for(var t,r=$("#"+n+" [data-slideshow-item]").find("[data-trimline]:not([data-disabled])"),i=0;i<r.length;i++)t=$(r[i]),/^[0-9]+$/ig.test(t.attr("data-trimline"))&&t.trimLine(+t.attr("data-trimline"))},init:function(){var e,f,t,n,i,r;for(this.unload(),e=$("[data-slideshow]:not([data-exclude])"),$("[data-slideshow]").on({mouseenter:function(n){window._cnnd.slideshow.hovering[$(n.target).closest("[data-slideshow]").attr("id")]=!0},mouseleave:function(n){window._cnnd.slideshow.hovering[$(n.target).closest("[data-slideshow]").attr("id")]=!1}}).css("scroll-behavior","smooth"),f=0;f<e.length;f++){t=$(e[f]);t.attr("id")?n=t.attr("id"):(n="slideshow-"+Math.round(Math.random()*(new Date).getTime()),t.attr("id",n));window._cnnd.slideshow.elements[n]=0;var u=$("#"+n+" [data-slideshow-thumbs] [data-slideshow-item]"),s=Number(t.attr("data-slideshow-step")||1),o=$("#"+n+" ul[data-slideshow-thumbs]");if(!u.length&&o.length)for(i=0;i<$("#"+n+" [data-slideshow-slides] [data-slideshow-item]").length;i+=s)o.append('<li data-slideshow-item="'+i+'"><\/li>');for(u=$("#"+n+" [data-slideshow-thumbs] [data-slideshow-item]"),u.removeClass("active"),i=0;i<u.length;i++)r=u[i],i===0&&$(r).addClass("active"),$(r).attr("data-slideshow-item")||/^[0-9]+$/ig.test($(r).attr("data-slideshow-item"))?r.onclick=window._cnnd.slideshow.changeSlide(n+"",$(r)):($(r).attr("data-slideshow-item",i),r.onclick=window._cnnd.slideshow.changeSlide(n+"",$(r)));$("#"+n+" [data-slideshow-slides] [data-slideshow-item]").removeClass("active").each(function(n){$(this).attr("data-slideshow-item",n+"")});$("#"+n+" [data-slideshow-slides] [data-slideshow-item]:first-child").addClass("active");$("#"+n+" [data-slideshow-slides][data-slideshow-scrollable]").on("mousedown",function(n){var t=$(this),i=t.closest("[data-slideshow]").attr("id");t.attr("data-slideshow-scrollable")&&(window._cnnd.slideshow.pageX[i+""]=n.pageX,window._cnnd.slideshow.scrolling[i+""]=!0)}).on("mouseup",function(){var n=$(this),r=n.closest("[data-slideshow]").attr("id"),i,t,u;n.attr("data-slideshow-scrollable")&&(window._cnnd.slideshow.scrolling[r+""]=!1,n.attr("data-slideshow-nochange")||(i=[],t=n.find("[data-slideshow-item]"),t.each(function(){i.push(Math.abs(n.offset().left-$(this).offset().left))}),u=Math.min.apply(null,i),n[0].scrollLeft+n.width()>=n[0].scrollWidth?window._cnnd.slideshow.changeSlide(r,$(t[t.length-1]))():window._cnnd.slideshow.changeSlide(r,$(t[i.indexOf(u)]))()))}).on("mousemove",function(n){var t=$(this),i=t.closest("[data-slideshow]").attr("id"),r=window._cnnd.slideshow.pageX[i+""];t.attr("data-slideshow-scrollable")&&window._cnnd.slideshow.scrolling[i+""]&&r&&(t[0].scrollLeft+=r-n.pageX,window._cnnd.slideshow.pageX[i+""]=n.pageX)}).find("[data-slideshow-item]").on("click mouseup",function(n){var t=$(this),i=t.closest("[data-slideshow]").attr("id"),e=window._cnnd.slideshow.pageX[i+""],u,r,f;if(t.attr("data-slideshow-act")){if(t.attr("data-slideshow-act")!="down"&&t.attr("data-slideshow-act")!="pending"||Math.abs(t.closest("[data-slideshow]")[0].scrollLeft-e)<=30){if(n.preventDefault(),n.stopPropagation(),t=t.closest("[data-slideshow-slides]"),!t.attr("data-slideshow-scrollable"))return;window._cnnd.slideshow.scrolling[i+""]=!1;window._cnnd.slideshow.pageX[i+""]=0;t=t.closest("[data-slideshow-slides]");t.attr("data-slideshow-nochange")||(u=[],r=t.find("[data-slideshow-item]"),r.each(function(){u.push(Math.abs(t.offset().left-$(this).offset().left))}),f=Math.min.apply(null,u),t[0].scrollLeft+t.width()>=t[0].scrollWidth?window._cnnd.slideshow.changeSlide(i,$(r[r.length-1]))():window._cnnd.slideshow.changeSlide(i,$(r[u.indexOf(f)]))());setTimeout(function(){$("[data-slideshow-act]").removeAttr("data-slideshow-act")},300);return}$("[data-slideshow-act]").removeAttr("data-slideshow-act");$(this).closest("[data-slideshow-slides]").mouseup()}}).on("mouseout",function(){$(this).attr("data-slideshow-act")&&$(this).attr("data-slideshow-act","dragout")}).on("mousedown",function(n){n.preventDefault();$(this).attr("data-slideshow-act","down")}).on("mousemove",function(n){var t=$(this);t.attr("data-slideshow-act")=="down"&&t.attr("data-slideshow-act")!="pending"&&(t.attr("data-slideshow-act","pending"),n.preventDefault(),setTimeout(function(){t.attr("data-slideshow-act")=="pending"&&t.attr("data-slideshow-act","drag")},200))});$("body").on("mousemove",function(n){var u=$("[data-slideshow] [data-slideshow-act='dragout']"),t,i,r;u.length&&(t=u.closest("[data-slideshow]").attr("id"),t)&&(i=$("#"+t+" [data-slideshow-slides][data-slideshow-scrollable]"),i.length)&&(r=window._cnnd.slideshow.pageX[t+""],r)&&(i[0].scrollLeft+=r-n.pageX,window._cnnd.slideshow.pageX[t+""]=n.pageX)}).on("mouseup",function(){var n=$("[data-slideshow-act]");n.removeAttr("data-slideshow-act");$(n[0]).mouseup()});try{$("#"+n+" [data-slideshow-next]")[0].onclick=window._cnnd.slideshow.changeSlide(n+"",0,1,$("#"+n+" [data-slideshow-next]"))}catch(h){}try{$("#"+n+" [data-slideshow-prev]").addClass("disabled")[0].onclick=window._cnnd.slideshow.changeSlide(n+"",0,-1,$("#"+n+" [data-slideshow-prev]"))}catch(h){}t.find("[data-slideshow-slides]").on("swiperight",window._cnnd.slideshow.changeSlide(n+"",0,-1));t.find("[data-slideshow-slides]").on("swipeleft",window._cnnd.slideshow.changeSlide(n+"",0,1));t.attr("data-slideshow-interval")&&/[0-9]+/ig.test(t.attr("data-slideshow-interval"))&&(window._cnnd.slideshow.hovering[n]=!1,window._cnnd.slideshow.intervals[n]=setInterval(window._cnnd.slideshow.intervalDecoration(n),+t.attr("data-slideshow-interval")));console.debug("[SLIDESHOW] Initialized slideshow #"+n)}},unload:function(n){var t,i,r;if(n){this.intervals[n]&&clearInterval(this.intervals[n]);this.elements[n]=null;t=$("#"+n);t.find("[data-slideshow-thumbs] [data-slideshow-item], [data-slideshow-next]:not(.disabled), [data-ignore-disabled] [data-slideshow-next].disabled, [data-slideshow-prev]:not(.disabled), [data-ignore-disabled] [data-slideshow-prev].disabled").on("click",function(){});t.find("[data-slideshow]").on({mouseenter:function(){},mouseleave:function(){}});t.find("[data-slideshow-slides][data-slideshow-scrollable]").off("mousedown").off("mouseup").off("mousemove").off("mouseout").find("li,a").off("click mouseup mousedown mousemove");console.debug("[SLIDESHOW] Unloaded slideshow #"+n);return}if(i=Object.keys(this.elements),!(i.length<=0)){for(console.debug("[SLIDESHOW] Unloaded ALL:"),r=0;r<i.length;r++)this.unload(i[r]);console.debug("[SLIDESHOW] Unloaded ALL: Done.")}}};$(document).ready(function(){window._cnnd.slideshow.init()});$(document).ready(function(){});